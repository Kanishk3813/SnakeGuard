    ...
    >
      ...
      >
        ...
        <View style={styles.logoSection}>
          ...
          <Text style={styles.tagline}>Snake Detection Response System</Text>
        </View>

        {/* Form Section */}
        <View style={[styles.formCard, shadows.md]}>
          <Text style={styles.welcomeTitle}>Responder Login</Text>
          <Text style={styles.welcomeSubtitle}>
            Sign in to receive and respond to snake detection assignments
          </Text>
          ...
          >
            {loading ? (
              ...
              <>
                ...
                <Text style={styles.signInButtonText}>Sign In as Responder</Text>
              </>
            )}
          </Pressable>
        </View>
        ...
        <View style={styles.footerNote}>
          ...
          <Text style={styles.footerText}>
            Only registered responders can access this app. Contact your admin for access.
          </Text>
        </View>
      </ScrollView>
    </KeyboardAvoidingView>
