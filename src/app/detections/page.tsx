...
export default function DetectionsPage() {
  ...
  const filteredDetections = detections.filter(detection => {
    ...
    return (
      (detection.species && detection.species.toLowerCase().includes(searchTerm.toLowerCase())) ||
      (detection.notes && detection.notes.toLowerCase().includes(searchTerm.toLowerCase())) ||
      new Date(detection.timestamp).toLocaleString().toLowerCase().includes(searchTerm.toLowerCase())
    );
  });
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-2xl font-bold text-gray-900 mb-8">Snake Detections</h1>
              ...
              <>
                {filteredDetections.length === 0 ? (
                  <div className="bg-white rounded-lg shadow-md p-6 text-center">
                    ...
                    <h3 className="text-lg font-medium text-gray-900">No detections found</h3>
